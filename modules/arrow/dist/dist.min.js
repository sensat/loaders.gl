(() => {
  ...
  // src/arrow-loader.ts
  var VERSION, ArrowLoader;
  var init_arrow_loader = __esm({
    "src/arrow-loader.ts"() {
  ...
  var MetadataVersion, UnionMode, Precision, DateUnit, TimeUnit, IntervalUnit, MessageHeader, Type, BufferType;
  var init_enum = __esm({
    "../../node_modules/apache-arrow/enum.mjs"() {
  ...
  var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p, _q, _r, _s, _t, _u, DataType, Null, Int_, Int8, Int16, Int32, Int64, Uint8, Uint16, Uint32, Uint64, Float, Float16, Float32, Float64, Binary, Utf8, Bool, Decimal, Date_, DateMillisecond, Time_, Timestamp_, Interval_, List, Struct, Union_, FixedSizeBinary, FixedSizeList, Map_, getId, Dictionary;
  var init_type = __esm({
    "../../node_modules/apache-arrow/type.mjs"() {
      init_enum();
      DataType = class {
      ...
      Decimal = class extends DataType {
      ...
      DateMillisecond = class extends Date_ {
        constructor() {
      ...
      FixedSizeBinary = class extends DataType {
...
return true;`);
  ...
  var init_int2 = __esm({
    "../../node_modules/apache-arrow/util/int.mjs"() {
      ...
      Uint642 = class extends BaseInt64 {
        times(other) {
          this._times(other);
          return this;
        }
      ...
      Int642 = class extends BaseInt64 {
        negate() {
  ...
  var init_parse_arrow_sync = __esm({
    "src/lib/parse-arrow-sync.ts"() {
      init_Arrow_dom();
    }
  });
  ...
  var init_parse_arrow_in_batches = __esm({
    "src/lib/parse-arrow-in-batches.ts"() {
      init_Arrow_dom();
    }
  });
  ...
  // src/arrow-writer.ts
  var VERSION2, ArrowWriter;
  var init_arrow_writer = __esm({
    "src/arrow-writer.ts"() {
      init_encode_arrow();
  ...
  __export(src_exports, {
    ...
    VECTOR_TYPES: () => VECTOR_TYPES,
    _typecheckArrowLoader: () => _typecheckArrowLoader
  });
  var ArrowLoader2, _typecheckArrowLoader;
  var init_src2 = __esm({
    "src/index.ts"() {
      init_arrow_loader();
      init_parse_arrow_sync();
      init_parse_arrow_in_batches();
      init_src();
      init_arrow_table_batch();
      init_types();
      init_arrow_writer();
      ...
      _typecheckArrowLoader = ArrowLoader2;
    }
  });
