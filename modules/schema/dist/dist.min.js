(() => {
  ...
  var ArrowLikeField;
  var init_arrow_like_field = __esm({
    "src/lib/table/arrow-api/arrow-like-field.ts"() {
      ArrowLikeField = class {
        constructor(name, type, nullable = false, metadata2 = new Map()) {
          this.name = name;
          this.type = type;
  ...
  var ArrowLikeSchema;
  var init_arrow_like_schema = __esm({
    "src/lib/table/arrow-api/arrow-like-schema.ts"() {
      init_arrow_like_field();
      ArrowLikeSchema = class {
        constructor(fields, metadata2 = new Map()) {
          this.fields = fields.map((field) => new ArrowLikeField(field.name, field.type, field.nullable, field.metadata));
          this.metadata = metadata2 instanceof Map ? metadata2 : new Map(Object.entries(metadata2));
        }
        compareTo(other) {
        ...
        assign(schemaOrFields) {
          ...
          if (schemaOrFields instanceof ArrowLikeSchema) {
            ...
            metadata2 = mergeMaps(mergeMaps(new Map(), this.metadata), otherArrowLikeSchema.metadata);
          } else {
          ...
          return new ArrowLikeSchema(mergedFields, metadata2);
        }
      };
    }
  });
  ...
  var ArrowLikeVector, ArrowLikeTable;
  var init_arrow_like_table = __esm({
    "src/lib/table/arrow-api/arrow-like-table.ts"() {
      init_arrow_like_schema();
      init_table_schema();
      init_table_accessors();
      ArrowLikeVector = class {
  ...
  function deduceMeshSchema(attributes, metadata2 = {}) {
    const fields = deduceMeshFields(attributes);
    return { fields, metadata: metadata2 };
  }
  function deduceMeshField(name, attribute, optionalMetadata) {
    const type = getDataTypeFromTypedArray(attribute.value);
    const metadata2 = optionalMetadata ? optionalMetadata : makeMeshAttributeMetadata(attribute);
    return {
      name,
  ...
  var init_arrow_like_type = __esm({
    "src/lib/table/arrow-api/arrow-like-type.ts"() {
      init_enum();
      init_enum();
      DataType = class {
  ...
  // src/lib/table/arrow-api/index.ts
  var init_arrow_api = __esm({
    "src/lib/table/arrow-api/index.ts"() {
      init_arrow_like_field();
      init_arrow_like_schema();
      init_arrow_like_type();
    }
  });
  ...
  var MetadataVersion, UnionMode, Precision2, DateUnit2, TimeUnit2, IntervalUnit2, MessageHeader, Type2, BufferType;
    ...
    "../../node_modules/apache-arrow/type.mjs"() {
      ...
      DataType2 = class {
        ...
        static isDenseUnion(x) {
          return DataType2.isUnion(x) && x.mode === UnionMode.Dense;
        }
        static isSparseUnion(x) {
          return DataType2.isUnion(x) && x.mode === UnionMode.Sparse;
        }
        get typeId() {
          return Type2.NONE;
        }
      ...
      Object.defineProperty(Int642.prototype, "ArrayType", { value: BigInt64Array });
      ...
      Object.defineProperty(Uint642.prototype, "ArrayType", { value: BigUint64Array });
      Float2 = class extends DataType2 {
        constructor(precision) {
          super();
          this.precision = precision;
        }
      ...
      Float162 = class extends Float2 {
        constructor() {
          super(Precision2.HALF);
        }
      };
      Float322 = class extends Float2 {
        constructor() {
          super(Precision2.SINGLE);
        }
      };
      Float642 = class extends Float2 {
        constructor() {
      ...
      Binary2 = class extends DataType2 {
        constructor() {
          super();
        }
        get typeId() {
      ...
      Decimal = class extends DataType2 {
      ...
      Timestamp_ = class extends DataType2 {
      ...
      Interval_ = class extends DataType2 {
        constructor(unit) {
          super();
          this.unit = unit;
        }
      ...
      Struct2 = class extends DataType2 {
        constructor(children) {
          super();
          this.children = children;
        }
      ...
      Union_ = class extends DataType2 {
      ...
      FixedSizeBinary = class extends DataType2 {
      ...
      FixedSizeList2 = class extends DataType2 {
        constructor(listSize, child) {
          super();
          this.listSize = listSize;
          this.children = [child];
      ...
      FixedSizeList2[_s] = ((proto) => {
        proto.children = null;
        proto.listSize = null;
        return proto[Symbol.toStringTag] = "FixedSizeList";
      })(FixedSizeList2.prototype);
      Map_ = class extends DataType2 {
      ...
      Dictionary = class extends DataType2 {
  ...
  var init_set = __esm({
    "../../node_modules/apache-arrow/visitor/set.mjs"() {
      ...
      setDate = (data, index, value) => {
        data.type.unit === DateUnit2.DAY ? setDateDay(data, index, value) : setDateMillisecond(data, index, value);
      };
      setTimestampSecond = ({ values }, index, value) => setEpochMsToMillisecondsLong(values, index * 2, value / 1e3);
      setTimestampMillisecond = ({ values }, index, value) => setEpochMsToMillisecondsLong(values, index * 2, value);
      setTimestampMicrosecond = ({ values }, index, value) => setEpochMsToMicrosecondsLong(values, index * 2, value);
      setTimestampNanosecond = ({ values }, index, value) => setEpochMsToNanosecondsLong(values, index * 2, value);
      ...
      _setStructMapValue = (o, v) => (set, c, f, _) => c && set(c, o, v.get(f.name));
      ...
      setIntervalValue = (data, index, value) => {
        data.type.unit === IntervalUnit2.DAY_TIME ? setIntervalDayTime(data, index, value) : setIntervalYearMonth(data, index, value);
      };
  ...
  var init_get = __esm({
    "../../node_modules/apache-arrow/visitor/get.mjs"() {
      ...
      epochMillisecondsLongToMs = (data, index) => 4294967296 * data[index + 1] + (data[index] >>> 0);
      epochMicrosecondsLongToMs = (data, index) => 4294967296 * (data[index + 1] / 1e3) + (data[index] >>> 0) / 1e3;
      epochNanosecondsLongToMs = (data, index) => 4294967296 * (data[index + 1] / 1e6) + (data[index] >>> 0) / 1e6;
      epochMillisecondsToDate = (epochMs) => new Date(epochMs);
      epochDaysToDate = (data, index) => epochMillisecondsToDate(epochDaysToMs(data, index));
      epochMillisecondsLongToDate = (data, index) => epochMillisecondsToDate(epochMillisecondsLongToMs(data, index));
      ...
      getDateDay = ({ values }, index) => epochDaysToDate(values, index);
      getDateMillisecond = ({ values }, index) => epochMillisecondsLongToDate(values, index * 2);
      ...
      getFloat = ({ type, values }, index) => type.precision !== Precision2.HALF ? values[index] : uint16ToFloat64(values[index]);
      getDate = (data, index) => data.type.unit === DateUnit2.DAY ? getDateDay(data, index) : getDateMillisecond(data, index);
      getTimestampSecond = ({ values }, index) => 1e3 * epochMillisecondsLongToMs(values, index * 2);
      getTimestampMillisecond = ({ values }, index) => epochMillisecondsLongToMs(values, index * 2);
      getTimestampMicrosecond = ({ values }, index) => epochMicrosecondsLongToMs(values, index * 2);
      getTimestampNanosecond = ({ values }, index) => epochNanosecondsLongToMs(values, index * 2);
      ...
      getInterval = (data, index) => data.type.unit === IntervalUnit2.DAY_TIME ? getIntervalDayTime(data, index) : getIntervalYearMonth(data, index);
  ...
  var kKeys, kVals, MapRow, MapRowIterator, MapRowProxyHandler;
  var init_map = __esm({
    "../../node_modules/apache-arrow/row/map.mjs"() {
      init_vector2();
      init_pretty();
  ...
  var kUnknownNullCount, Data, MakeDataVisitor;
  var init_data = __esm({
    "../../node_modules/apache-arrow/data.mjs"() {
      init_vector2();
      init_enum2();
      ...
      MakeDataVisitor = class extends Visitor {
        visit(props) {
  ...
  function vectorIterator(vector) {
    const { type } = vector;
    if (vector.nullCount === 0 && vector.stride === 1 && (type.typeId === Type2.Timestamp || type instanceof Int_ && type.bitWidth !== 64 || type instanceof Time_ && type.bitWidth !== 64 || type instanceof Float2 && type.precision !== Precision2.HALF)) {
  ...
  var sum, GetByteLengthVisitor, getUtf8ByteLength, getBinaryByteLength, getListByteLength, getFixedSizeListByteLength, getUnionByteLength, getDenseUnionByteLength, getSparseUnionByteLength, instance5;
  var init_bytelength = __esm({
    "../../node_modules/apache-arrow/visitor/bytelength.mjs"() {
      init_visitor();
      init_enum2();
      sum = (x, y) => x + y;
      GetByteLengthVisitor = class extends Visitor {
        visitNull(____, _) {
          return 0;
        }
        visitInt(data, _) {
      ...
      getUtf8ByteLength = ({ valueOffsets }, index) => {
        return 8 + (valueOffsets[index + 1] - valueOffsets[index]);
      };
      getBinaryByteLength = ({ valueOffsets }, index) => {
        return 8 + (valueOffsets[index + 1] - valueOffsets[index]);
      };
      getListByteLength = ({ valueOffsets, stride, children }, index) => {
        const child = children[0];
      ...
      getFixedSizeListByteLength = ({ stride, children }, index) => {
        const child = children[0];
        const slice = child.slice(index * stride, stride);
        const visit = instance5.getVisitFn(child.type);
        let size = 0;
      ...
      instance5 = new GetByteLengthVisitor();
    }
  });
  ...
  var init_vector2 = __esm({
    "../../node_modules/apache-arrow/vector.mjs"() {
      ...
      MemoizedVector = class extends Vector {
        constructor(vector) {
          super(vector.data);
          const get = this.get;
          const set = this.set;
...
return true;`);
  ...
  var roundLengthUpToNearest64Bytes, sliceOrExtendArray, BufferBuilder, DataBufferBuilder, BitmapBufferBuilder, OffsetsBufferBuilder;
  ...
  var Builder, FixedWidthBuilder, VariableWidthBuilder;
  var init_builder = __esm({
    "../../node_modules/apache-arrow/builder.mjs"() {
      ...
      FixedWidthBuilder = class extends Builder {
        constructor(opts) {
          super(opts);
      ...
      VariableWidthBuilder = class extends Builder {
        constructor(opts) {
          super(opts);
  ...
  // ../../node_modules/apache-arrow/node_modules/flatbuffers/mjs/flatbuffers.js
    ...
    "../../node_modules/apache-arrow/fb/binary.mjs"() {
      ...
      Binary3 = class {
        ...
        static createBinary(builder) {
          Binary3.startBinary(builder);
          return Binary3.endBinary(builder);
        }
      };
    }
  });
    ...
    "../../node_modules/apache-arrow/fb/bool.mjs"() {
      ...
      Bool3 = class {
        ...
        static createBool(builder) {
          Bool3.startBool(builder);
          return Bool3.endBool(builder);
        }
      };
    }
  });
  ...
  var FixedSizeBinary2;
  var init_fixed_size_binary = __esm({
    "../../node_modules/apache-arrow/fb/fixed-size-binary.mjs"() {
      init_flatbuffers();
      FixedSizeBinary2 = class {
        constructor() {
          this.bb = null;
          this.bb_pos = 0;
        }
    ...
    "../../node_modules/apache-arrow/fb/fixed-size-list.mjs"() {
      ...
      FixedSizeList3 = class {
        ...
        static createFixedSizeList(builder, listSize) {
          FixedSizeList3.startFixedSizeList(builder);
          FixedSizeList3.addListSize(builder, listSize);
          return FixedSizeList3.endFixedSizeList(builder);
        }
      };
    }
  });
    ...
    "../../node_modules/apache-arrow/fb/null.mjs"() {
      ...
      Null3 = class {
        ...
        static createNull(builder) {
          Null3.startNull(builder);
          return Null3.endNull(builder);
        }
      };
    }
  });
    ...
    "../../node_modules/apache-arrow/fb/utf8.mjs"() {
      ...
      Utf83 = class {
        ...
        static createUtf8(builder) {
          Utf83.startUtf8(builder);
          return Utf83.endUtf8(builder);
        }
      };
    }
  });
    ...
    "../../node_modules/apache-arrow/schema.mjs"() {
      ...
      Schema2 = class {
        ...
        assign(...args) {
          ...
          const metadata2 = mergeMaps2(mergeMaps2(new Map(), this.metadata), other.metadata);
          const newFields = other.fields.filter((f2) => {
            const i = curFields.findIndex((f) => f.name === f2.name);
            return ~i ? (curFields[i] = f2.clone({
              metadata: mergeMaps2(mergeMaps2(new Map(), curFields[i].metadata), f2.metadata)
            })) && false : true;
          });
  ...
  var carryBit16, kInt32DecimalDigits, kPowersOfTen, BaseInt64, Uint643, Int643, Int128;
  var init_int2 = __esm({
    "../../node_modules/apache-arrow/util/int.mjs"() {
      carryBit16 = 1 << 16;
      ...
      Uint643 = class extends BaseInt64 {
        times(other) {
          this._times(other);
          return this;
        }
        ...
        static from(val, out_buffer = new Uint32Array(2)) {
          return Uint643.fromString(typeof val === "string" ? val : val.toString(), out_buffer);
        }
        static fromNumber(num, out_buffer = new Uint32Array(2)) {
          return Uint643.fromString(num.toString(), out_buffer);
        }
        static fromString(str, out_buffer = new Uint32Array(2)) {
          const length = str.length;
          const out = new Uint643(out_buffer);
          for (let posn = 0; posn < length; ) {
            const group = kInt32DecimalDigits < length - posn ? kInt32DecimalDigits : length - posn;
            const chunk = new Uint643(new Uint32Array([Number.parseInt(str.slice(posn, posn + group), 10), 0]));
            const multiple = new Uint643(new Uint32Array([kPowersOfTen[group], 0]));
            out.times(multiple);
            out.plus(chunk);
            posn += group;
          }
        ...
        static convertArray(values) {
          ...
          for (let i = -1, n = values.length; ++i < n; ) {
            Uint643.from(values[i], new Uint32Array(data.buffer, data.byteOffset + 2 * i * 4, 2));
          }
          return data;
        }
        static multiply(left, right) {
          const rtrn = new Uint643(new Uint32Array(left.buffer));
      ...
      Int643 = class extends BaseInt64 {
        negate() {
        ...
        static from(val, out_buffer = new Uint32Array(2)) {
          return Int643.fromString(typeof val === "string" ? val : val.toString(), out_buffer);
        }
        static fromNumber(num, out_buffer = new Uint32Array(2)) {
          return Int643.fromString(num.toString(), out_buffer);
        }
        static fromString(str, out_buffer = new Uint32Array(2)) {
          const negate = str.startsWith("-");
          const length = str.length;
          const out = new Int643(out_buffer);
          for (let posn = negate ? 1 : 0; posn < length; ) {
            const group = kInt32DecimalDigits < length - posn ? kInt32DecimalDigits : length - posn;
            const chunk = new Int643(new Uint32Array([Number.parseInt(str.slice(posn, posn + group), 10), 0]));
            const multiple = new Int643(new Uint32Array([kPowersOfTen[group], 0]));
            out.times(multiple);
            out.plus(chunk);
            posn += group;
          }
        ...
        static convertArray(values) {
          const data = new Uint32Array(values.length * 2);
          for (let i = -1, n = values.length; ++i < n; ) {
            Int643.from(values[i], new Uint32Array(data.buffer, data.byteOffset + 2 * i * 4, 2));
          }
          return data;
        }
        static multiply(left, right) {
          const rtrn = new Int643(new Uint32Array(left.buffer));
          return rtrn.times(right);
        }
        static add(left, right) {
          const rtrn = new Int643(new Uint32Array(left.buffer));
      ...
      Int128 = class {
        ...
        high() {
          return new Int643(new Uint32Array(this.buffer.buffer, this.buffer.byteOffset + 8, 2));
        }
        low() {
          return new Int643(new Uint32Array(this.buffer.buffer, this.buffer.byteOffset, 2));
        }
        negate() {
          this.buffer[0] = ~this.buffer[0] + 1;
          this.buffer[1] = ~this.buffer[1];
        ...
        times(other) {
          const L0 = new Uint643(new Uint32Array([this.buffer[3], 0]));
          const L1 = new Uint643(new Uint32Array([this.buffer[2], 0]));
          const L2 = new Uint643(new Uint32Array([this.buffer[1], 0]));
          const L3 = new Uint643(new Uint32Array([this.buffer[0], 0]));
          const R0 = new Uint643(new Uint32Array([other.buffer[3], 0]));
          const R1 = new Uint643(new Uint32Array([other.buffer[2], 0]));
          const R2 = new Uint643(new Uint32Array([other.buffer[1], 0]));
          const R3 = new Uint643(new Uint32Array([other.buffer[0], 0]));
          let product = Uint643.multiply(L3, R3);
          this.buffer[0] = product.low();
          const sum2 = new Uint643(new Uint32Array([product.high(), 0]));
          product = Uint643.multiply(L2, R3);
          sum2.plus(product);
          product = Uint643.multiply(L3, R2);
          sum2.plus(product);
          this.buffer[1] = sum2.low();
          this.buffer[3] = sum2.lessThan(product) ? 1 : 0;
          this.buffer[2] = sum2.high();
          const high = new Uint643(new Uint32Array(this.buffer.buffer, this.buffer.byteOffset + 8, 2));
          high.plus(Uint643.multiply(L1, R3)).plus(Uint643.multiply(L2, R2)).plus(Uint643.multiply(L3, R1));
          this.buffer[3] += Uint643.multiply(L0, R3).plus(Uint643.multiply(L1, R2)).plus(Uint643.multiply(L2, R1)).plus(Uint643.multiply(L3, R0)).low();
          return this;
        }
        plus(other) {
      ...
      JSONVectorLoader = class extends VectorLoader {
        ...
        readData(type, { offset } = this.nextBufferRange()) {
          ...
          if (DataType2.isTimestamp(type)) {
            return toArrayBufferView(Uint8Array, Int643.convertArray(sources[offset]));
          } else if ((DataType2.isInt(type) || DataType2.isTime(type)) && type.bitWidth === 64) {
            return toArrayBufferView(Uint8Array, Int643.convertArray(sources[offset]));
  ...
  var init_bool2 = __esm({
    "../../node_modules/apache-arrow/builder/bool.mjs"() {
      init_buffer2();
      init_builder();
      BoolBuilder = class extends Builder {
        constructor(options) {
          super(options);
  ...
  var init_dictionary = __esm({
    "../../node_modules/apache-arrow/builder/dictionary.mjs"() {
      ...
      init_builder();
      init_factories();
      DictionaryBuilder = class extends Builder {
  ...
  var init_fixedsizelist = __esm({
    "../../node_modules/apache-arrow/builder/fixedsizelist.mjs"() {
      ...
      init_builder();
      init_type();
      FixedSizeListBuilder = class extends Builder {
        setValue(index, value) {
  ...
  var init_null2 = __esm({
    "../../node_modules/apache-arrow/builder/null.mjs"() {
      init_builder();
      NullBuilder = class extends Builder {
        setValue(index, value) {
        }
        setValid(index, valid) {
  ...
  var init_struct3 = __esm({
    "../../node_modules/apache-arrow/builder/struct.mjs"() {
      ...
      init_builder();
      init_type();
      StructBuilder = class extends Builder {
        setValue(index, value) {
  ...
  var init_union2 = __esm({
    "../../node_modules/apache-arrow/builder/union.mjs"() {
      ...
      init_builder();
      init_type();
      UnionBuilder = class extends Builder {
        constructor(options) {
          super(options);
  ...
  ${this.toArray().join(",\n  ")}
      ...
      Table[_a3] = ((proto) => {
        ...
        proto["getByteLength"] = wrapChunkedCall1(instance5.getVisitFn(Type2.Struct));
        return "Table";
      })(Table.prototype);
    }
  });
  ...
  function ensureSameLengthData(schema, chunks, maxLength = chunks.reduce((max, col) => Math.max(max, col.length), 0)) {
    ...
    return [
      ...
      makeData({ type: new Struct2(fields), length: maxLength, children })
    ];
  }
  ...
  var _a4, RecordBatch, _InternalEmptyPlaceholderRecordBatch;
  var init_recordbatch2 = __esm({
    "../../node_modules/apache-arrow/recordbatch.mjs"() {
      ...
      RecordBatch = class {
        constructor(...args) {
          switch (args.length) {
            ...
            case 1: {
              ...
              const data = makeData({ type: new Struct2(fields), length, children, nullCount: 0 });
        ...
        setChildAt(index, child) {
          ...
          if (index > -1 && index < this.numCols) {
            ...
            data = makeData({ type: new Struct2(fields), children });
          }
        ...
        selectAt(columnIndices) {
          ...
          const subset = makeData({ type: new Struct2(schema.fields), length: this.numRows, children });
      ...
      _InternalEmptyPlaceholderRecordBatch = class extends RecordBatch {
        constructor(schema) {
          const children = schema.fields.map((f) => makeData({ type: f.type }));
          const data = makeData({ type: new Struct2(schema.fields), nullCount: 0, children });
          super(schema, data);
        }
      };
    }
  ...
  var init_typeassembler = __esm({
    "../../node_modules/apache-arrow/visitor/typeassembler.mjs"() {
      ...
      TypeAssembler = class extends Visitor {
        ...
        visitBinary(_node, b) {
          Binary3.startBinary(b);
          return Binary3.endBinary(b);
        }
        visitBool(_node, b) {
          Bool3.startBool(b);
          return Bool3.endBool(b);
        }
        visitUtf8(_node, b) {
          Utf83.startUtf8(b);
          return Utf83.endUtf8(b);
        }
        visitDecimal(node, b) {
        ...
        visitFixedSizeList(node, b) {
          FixedSizeList3.startFixedSizeList(b);
          FixedSizeList3.addListSize(b, node.listSize);
          return FixedSizeList3.endFixedSizeList(b);
        }
        visitMap(node, b) {
          Map2.startMap(b);
  ...
  function fieldFromJSON(_field, dictionaries) {
    ...
    if (!dictionaries || !(dictMeta = _field["dictionary"])) {
      ...
      keys = (keys = dictMeta["indexType"]) ? indexTypeFromJSON(keys) : new Int322();
  ...
  function typeFromJSON(f, children) {
    ...
    switch (typeId) {
      ...
      case "date": {
        const t = f["type"];
        return new Date_(DateUnit2[t["unit"]]);
      }
      case "time": {
        const t = f["type"];
        return new Time_(TimeUnit2[t["unit"]], t["bitWidth"]);
      }
      case "timestamp": {
        const t = f["type"];
        return new Timestamp_(TimeUnit2[t["unit"]], t["timezone"]);
      }
      case "interval": {
        const t = f["type"];
        return new Interval_(IntervalUnit2[t["unit"]]);
      }
      case "union": {
        const t = f["type"];
  ...
  function decodeFieldType(f, children) {
    ...
    switch (typeId) {
      ...
      case Type3["FixedSizeList"]: {
        const t = f.type(new FixedSizeList3());
        return new FixedSizeList2(t.listSize(), (children || [])[0]);
      }
      case Type3["Map"]: {
  ...
  var init_reader = __esm({
    "../../node_modules/apache-arrow/ipc/reader.mjs"() {
      ...
      init_message3();
      init_compat();
      RecordBatchReader = class extends ReadableInterop {
        constructor(impl) {
          super();
          this._impl = impl;
        }
      ...
      RecordBatchReaderImpl = class {
        ...
        _loadRecordBatch(header, body) {
          ...
          const data = makeData({ type: new Struct2(this.schema.fields), length: header.length, children });
  ...
  var init_writer = __esm({
    "../../node_modules/apache-arrow/ipc/writer.mjs"() {
      ...
      RecordBatchStreamWriter = class extends RecordBatchWriter {
      ...
      RecordBatchFileWriter = class extends RecordBatchWriter {
  ...
  var init_Arrow = __esm({
    "../../node_modules/apache-arrow/Arrow.mjs"() {
      ...
      init_vector();
      init_typecomparator();
      util = Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, bn_exports), int_exports), bit_exports), math_exports), buffer_exports), vector_exports), {
        compareSchemas,
        compareFields,
        compareTypes
      });
  ...
  // src/lib/table/arrow/arrow-type-utils.ts
  ...
  var init_arrow_type_utils = __esm({
    "src/lib/table/arrow/arrow-type-utils.ts"() {
      init_Arrow_dom();
    }
  });
