...
import {Tile3D, Tileset3D} from '@sensat/loaders-gl-tiles';
...
const TILESET_EMPTY_ROOT_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Tilesets/TilesetEmptyRoot/tileset.json';

// Tileset with 3 levels of uniform subdivision
const TILESET_UNIFORM = '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Tilesets/TilesetUniform/tileset.json';

const TILESET_REPLACEMENT_1_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Tilesets/TilesetReplacement1/tileset.json';
const TILESET_REPLACEMENT_2_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Tilesets/TilesetReplacement2/tileset.json';
const TILESET_REPLACEMENT_3_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Tilesets/TilesetReplacement3/tileset.json';

// 3 level tree with mix of additive and replacement refinement
const TILESET_REFINEMENT_MIX =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Tilesets/TilesetRefinementMix/tileset.json';
...
const WITH_BOUNDING_SPHERE_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Batched/BatchedWithBoundingSphere/tileset.json';
...
const INSTANCED_RED_MATERIAL_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Instanced/InstancedRedMaterial/tileset.json';

// 1 tile where each feature is a different source color
const COLORS_URL = '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Batched/BatchedColors/tileset.json';
...
const TRANSLUCENT_URL = '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Batched/BatchedTranslucent/tileset.json';
...
const TILESET_WITH_TRANSFORMS_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Tilesets/TilesetWithTransforms/tileset.json';

// Root tile with 4 b3dm children and 1 pnts child with a viewer request volume
const TILESET_WITH_VIEWER_REQUEST_VOLUME_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Tilesets/TilesetWithViewerRequestVolume/tileset.json';
...
const TILESET_REPLACEMENT_WITH_VIEWER_REQUEST_VOLUME_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Tilesets/TilesetReplacementWithViewerRequestVolume/tileset.json';

const TILESET_WITH_EXTERNAL_RESOURCES_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Tilesets/TilesetWithExternalResources/tileset.json';
const TILESET_URL_WITH_CONTENT_URI =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Batched/BatchedWithContentDataUri/tileset.json';

const TILESET_SUBTREE_EXPIRATION_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Tilesets/TilesetSubtreeExpiration/tileset.json';
const TILESET_SUBTREE_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Tilesets/TilesetSubtreeExpiration/subtree.json';
const BATCHED_EXPIRATION_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Batched/BatchedExpiration/tileset.json';
const BATCHED_COLORS_B3DM_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Batched/BatchedColors/batchedColors.b3dm';
const BATCHED_VERTEX_COLORS_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Batched/BatchedWithVertexColors/tileset.json';

const STYLE_URL = '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Style/style.json';

const POINT_CLOUD_URL = '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/PointCloud/PointCloudRGB/tileset.json';
const POINT_CLOUD_BATCHED_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/PointCloud/PointCloudBatched/tileset.json';
*/
...
test('Tileset3D#url set up correctly given tileset JSON filepath', async (t) => {
  ...
  // NOTE: The url has been resolved (@sensat/loaders-gl-3d-tiles => localhost) so initial part is now different
...
test('Tileset3D#preserves query string with external tileset JSON file', t => {
  ...
  const queryParams = 'a=1&b=boy';
  const expectedUrl =
    '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Tilesets/TilesetOfTilesets/tileset.json?' + queryParams;
  const queryPar= await loadTileset(scene, TILESET_OF_TILESETS_URL + ;
    ...
    .then(function() {
      ...
      expectedUrl = getAbsoluteUri(
        '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Tilesets/TilesetOfTilesets/tileset2.json?v=1.2.3&' +
          queryParams
      );
      t.equals(Resource._Implementations.loadWithXhr.calls.argsFor(0)[0], expectedUrl);
    });
