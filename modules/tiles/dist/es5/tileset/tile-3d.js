...
var Tile3D = function () {
  function Tile3D(tileset, header, parentHeader) {
    ...
    (0, _defineProperty2.default)(this, "_distanceToScreenCenter", 0);
    ...
    (0, _defineProperty2.default)(this, "_loadPriority", 0);
    (0, _defineProperty2.default)(this, "_screenPriority", 0);
  ...
  (0, _createClass2.default)(Tile3D, [{
    ...
    key: "_getLoadPriority",
    value: function _getLoadPriority() {
    ...
    key: "_getScreenPriority",
    value: function _getScreenPriority() {
      var traverser = this.tileset._traverser;
      var skipLevelOfDetail = traverser.options.skipLevelOfDetail;
      var maySkipTile = this.refine === _constants.TILE_REFINEMENT.ADD || skipLevelOfDetail;
        ...
        return _regenerator.default.wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              _context.next = 9;
              return this.tileset._requestScheduler.scheduleRequest(this.id, this._getLoadPriority.bind(this));
            case 9:
    ...
    key: "distanceToScreenCenter",
    value: function distanceToScreenCenter(frameState) {
      var center = this.boundingVolume.center;
      var _frameState$viewport$ = frameState.viewport.project(center),
        _frameState$viewport$2 = (0, _slicedToArray2.default)(_frameState$viewport$, 2),
        screenX = _frameState$viewport$2[0],
        screenY = _frameState$viewport$2[1];
