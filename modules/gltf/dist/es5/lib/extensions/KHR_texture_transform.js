...
require("../types/gltf-json-schema");
...
function _decode() {
  _decode = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee(gltfData, options) {
    var gltfScenegraph, hasExtension, materials, i;
    return _regenerator.default.wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          gltfScenegraph = new _gltfScenegraph.GLTFScenegraph(gltfData);
          hasExtension = gltfScenegraph.hasExtension(EXT_MESHOPT_TRANSFORM);
          if (hasExtension) {
            _context.next = 4;
            break;
          }
...
function makeTransformationMatrix(extensionData) {
  ...
  var translationMatrix = new _core.Matrix3().set(1, 0, 0, 0, 1, 0, offset[0], offset[1], 1);
  var rotationMatrix = scratchRotationMatrix.set(Math.cos(rotation), Math.sin(rotation), 0, -Math.sin(rotation), Math.cos(rotation), 0, 0, 0, 1);
