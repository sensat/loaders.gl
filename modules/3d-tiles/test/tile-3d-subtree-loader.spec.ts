...
import {Tile3DSubtreeLoader} from '@sensat/loaders-gl-3d-tiles';

const FULL_SUBTREE_FILE_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/FullQuadtree/subtrees/0/0/0.subtree';
const INTERNAL_BINARY_SUBTREE_FILE_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/BasicExample/subtrees/0/0/0.subtree';
const INTERNAL_BINARY_SPARSE_SUBTREE_FILE_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/SparseOctree/subtrees/0/0/0/0.subtree';
