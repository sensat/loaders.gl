...
import {load, parseSync, encodeSync, LoaderContext} from '@sensat/loaders-gl-core';
...
/*
const POINTCLOUD_RGB_URL = '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/PointCloud/PointCloudRGB/tileset.json';
const POINTCLOUD_RGBA_URL = '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/PointCloud/PointCloudRGBA/tileset.json';
const POINTCLOUD_RGB565_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/PointCloud/PointCloudRGB565/tileset.json';
const POINTCLOUD_NO_COLOR_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/PointCloud/PointCloudNoColor/tileset.json';
const POINTCLOUD_CONSTANT_COLOR_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/PointCloud/PointCloudConstantColor/tileset.json';
const POINTCLOUD_NORMALS_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/PointCloud/PointCloudNormals/tileset.json';
const POINTCLOUD_NORMALS_OCT_ENCODED_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/PointCloud/PointCloudNormalsOctEncoded/tileset.json';
const POINTCLOUD_QUANTIZED_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/PointCloud/PointCloudQuantized/tileset.json';
const POINTCLOUD_QUANTIZED_OCT_ENCODED_URL =
  '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/PointCloud/PointCloudQuantizedOctEncoded/tileset.json';
const POINTCLOUD_DRACO_URL = '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/PointCloud/PointCloudDraco/tileset.json';
const POINTCLOUD_DRACO_PARTIAL_URL = '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/PointCloud/PointCloudDracoPartial/tileset.json';
const POINTCLOUD_DRACO_BATCHED_URL = '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/PointCloud/PointCloudDracoBatched/tileset.json';
const POINTCLOUD_WGS84_URL = '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/PointCloud/PointCloudWGS84/tileset.json';
const POINTCLOUD_BATCHED_URL = '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/PointCloud/PointCloudBatched/tileset.json';
const POINTCLOUD_WITH_PER_POINT_PROPERTIES_URL = '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/PointCloud/PointCloudWithPerPointProperties/tileset.json';
const POINTCLOUD_WITH_TRANSFORM_URL = '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/PointCloud/PointCloudWithTransform/tileset.json';
const POINTCLOUD_TILESET_URL = '@sensat/loaders-gl-3d-tiles/test/data/CesiumJS/Tilesets/TilesetPoints/tileset.json';
*/
...
test.skip('point cloud tile#64bit attribute', async (t) => {
  const POINTCLOUD_64BIT_URL = '@sensat/loaders-gl-3d-tiles/test/data/64-bit-attribute/1.pnts';
