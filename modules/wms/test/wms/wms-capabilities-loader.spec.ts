...
const WMS_ANALYSES_URL = '@sensat/loaders-gl-wms/test/data/wms/get-capabilities/analyses.xml';
const WMS_DMSP_URL = '@sensat/loaders-gl-wms/test/data/wms/get-capabilities/dmsp.xml';
const WMS_FORECASTS_URL = '@sensat/loaders-gl-wms/test/data/wms/get-capabilities/forecasts.xml';
const WMS_OBS_URL = '@sensat/loaders-gl-wms/test/data/wms/get-capabilities/obs.xml';
const WMS_WWA_URL = '@sensat/loaders-gl-wms/test/data/wms/get-capabilities/wwa.xml';

const WMS_ADHOC_URL = '@sensat/loaders-gl-wms/test/data/wms/get-capabilities/?.xml';
