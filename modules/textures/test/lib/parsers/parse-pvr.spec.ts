...
const TEST_CASES = [
  {
    url: '@sensat/loaders-gl-textures/test/data/shannon-pvrtc-2bpp-rgb.pvr',
    format: GL_COMPRESSED_RGB_PVRTC_2BPPV1_IMG,
    textureFormat: 'pvrtc-rgb2unorm-webgl'
  },
  {
    url: '@sensat/loaders-gl-textures/test/data/shannon-pvrtc-2bpp-rgba.pvr',
    format: GL_COMPRESSED_RGBA_PVRTC_2BPPV1_IMG,
    textureFormat: 'pvrtc-rgba2unorm-webgl'
  },
  {
    url: '@sensat/loaders-gl-textures/test/data/shannon-pvrtc-4bpp-rgb.pvr',
    format: GL_COMPRESSED_RGB_PVRTC_4BPPV1_IMG,
    textureFormat: 'pvrtc-rgb4unorm-webgl'
  },
  {
    url: '@sensat/loaders-gl-textures/test/data/shannon-pvrtc-4bpp-rgba.pvr',
    format: GL_COMPRESSED_RGBA_PVRTC_4BPPV1_IMG,
    textureFormat: 'pvrtc-rgba4unorm-webgl'
  },
  {
    url: '@sensat/loaders-gl-textures/test/data/shannon-astc-10x10.pvr',
    format: GL_COMPRESSED_RGBA_ASTC_10x10_KHR,
    textureFormat: 'astc-10x10-unorm'
  },
  {
    url: '@sensat/loaders-gl-textures/test/data/shannon-astc-srgb-10x10.pvr',
