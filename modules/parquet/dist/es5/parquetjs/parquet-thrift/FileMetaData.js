...
var ColumnOrder = _interopRequireWildcard(require("./ColumnOrder"));
var KeyValue = _interopRequireWildcard(require("./KeyValue"));
var RowGroup = _interopRequireWildcard(require("./RowGroup"));
var SchemaElement = _interopRequireWildcard(require("./SchemaElement"));
...
var FileMetaData = function () {
  ...
  (0, _createClass2.default)(FileMetaData, [{
    key: "write",
    value: function write(output) {
      ...
      if (this.schema != null) {
        ...
        this.schema.forEach(function (value_1) {
      ...
      if (this.row_groups != null) {
        ...
        this.row_groups.forEach(function (value_2) {
      ...
      if (this.column_orders != null) {
        ...
        this.column_orders.forEach(function (value_4) {
          ...
          case 2:
            if (fieldType === thrift.Thrift.Type.LIST) {
              ...
              for (var i_1 = 0; i_1 < size_1; i_1++) {
                var value_7 = SchemaElement.SchemaElement.read(input);
          ...
          case 4:
            if (fieldType === thrift.Thrift.Type.LIST) {
              ...
              for (var i_2 = 0; i_2 < size_2; i_2++) {
                var value_10 = RowGroup.RowGroup.read(input);
          ...
          case 7:
            if (fieldType === thrift.Thrift.Type.LIST) {
              ...
              for (var i_4 = 0; i_4 < size_4; i_4++) {
                var value_15 = ColumnOrder.ColumnOrder.read(input);
