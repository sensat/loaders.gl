...
import ClarinetParser from '@sensat/loaders-gl-json/lib/clarinet/clarinet';
...
const docs = {
  ...
  string_invalid_escape: {
    text: '["and you can\'t escape this"]',
    events: [
      ['openarray', undefined],
  ...
  non_utf8: {
    ...
    events: [
      ...
      [
        'value',
        'A corelet that provides the capability to upload a folder’s contents into a user’s locker.'
      ],
      ['key', 'functions'],
      ['openarray', undefined],
  ...
  numbers_game: {
    text:
      '[1,0,-1,-0.3,0.3,1343.32,3345,3.1e124,' +
  ...
  string_chunk_span: {
    ...
    chunks: ['["L\'OrÃ', '©al", "LÃ©\'Oral", "Ã©alL\'Or"]'],
    events: [
      ['openarray', undefined],
      ['value', "L'OrÃ©al"],
      ['value', "LÃ©'Oral"],
