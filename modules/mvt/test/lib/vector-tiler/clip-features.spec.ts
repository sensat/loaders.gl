  ...
  const expected = [
    {
      ...
      geometry: [
        [
          10, 0, 1, 40, 0, 1, 40, 10, 1, 20, 10, 0, 20, 20, 0, 30, 20, 0, 30, 30, 0, 40, 30, 1, 40,
          40, 1, 25, 40, 0, 25, 50, 0, 10, 50, 1, 10, 60, 1, 25, 60, 0, 10, 24, 1, 10, 0, 1
        ]
      ],
      tags: 1,
      minX: 10,
    ...
    },
    {
      id: null,
      type: 'Polygon',
      geometry: [[10, 0, 1, 40, 0, 1, 40, 10, 1, 10, 10, 1, 10, 0, 1]],
      tags: 2,
      minX: 10,
      minY: 0,
      maxX: 40,
