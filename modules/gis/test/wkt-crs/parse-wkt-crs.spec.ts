...
import {parseSync, encodeTextSync} from '@sensat/loaders-gl-core';
import {WKTCRSLoader, WKTCRSWriter} from '@sensat/loaders-gl-wkt';
...
// test.skip('parseWKTCRS#try to parse everything in crs.json', (t) => {
