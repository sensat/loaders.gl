...
const WKB_2D_TEST_CASES = '@sensat/loaders-gl-gis/test/data/wkb-testdata2d.json';
const WKB_2D_NAN_TEST_CASES = '@sensat/loaders-gl-gis/test/data/wkb-testdata2d-nan.json';
const WKB_Z_TEST_CASES = '@sensat/loaders-gl-gis/test/data/wkb-testdataZ.json';
const WKB_Z_NAN_TEST_CASES = '@sensat/loaders-gl-gis/test/data/wkb-testdataZ-nan.json';
