...
var _parseLas = require("./lib/parse-las");
...
var LASLoader = _objectSpread(_objectSpread({}, _lasLoader.LASLoader), {}, {
    ...
    var _parse = (0, _asyncToGenerator2.default)(_regenerator.default.mark(function _callee(arrayBuffer, options) {
      return _regenerator.default.wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            return _context.abrupt("return", (0, _parseLas.parseLAS)(arrayBuffer, options));
          case 1:
          case "end":
  ...
  parseSync: function parseSync(arrayBuffer, options) {
    return (0, _parseLas.parseLAS)(arrayBuffer, options);
  }
});
