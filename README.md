...
This fork publishes `v4.4.6-sensat.0` through GitHub Packages as
`@sensat/loaders-gl-<module>` (for example, `@sensat/loaders-gl-core`). Configure
the `@sensat` scope to use `https://npm.pkg.github.com` when installing packages.
