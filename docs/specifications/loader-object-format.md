...
To be compatible with the parsing/loading functions in `@sensat/loaders-gl-core` such as `parse` and `load`, a parser needs to be described by a "loader object" conforming to the following specification.
