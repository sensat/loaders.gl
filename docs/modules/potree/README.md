...
```bash
npm install @sensat/loaders-gl-potree
...
import {PotreeLoader} from `@sensat/loaders-gl-potree`;
...
`PotreeLoader` is intended to work with the 3d tileset classes in the `@sensat/loaders-gl-3d-tiles` module.
